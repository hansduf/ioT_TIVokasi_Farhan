...
const char *ssid = "5min=1k";
const char *password = "sosiologi";
...
void loop()
{
  ...
  if (currentMillis - previousMillis >= interval)
  {
    ...
    // Inisialisasi HTTPClient pio device monitor
    HTTPClient http;
    String url = "https://script.google.com/macros/s/AKfycbwfMnOmqIkDggDkjv0GfKXbVzQEFbI1dLev2nRiVoa135VeqnXrNKqNtWSurh_CBM8/exec"; // Ganti dengan URL ngrok yang benar
    http.begin(url);                                                 // Menggunakan HTTP, bukan HTTPS
    http.addHeader("Content-Type", "application/json");
    String payload = "{\"nama_sensor\":\"Sensor DADA\", \"nilai1\":" + String(h) + ", \"nilai2\":" + String(t) + "}";
